...
if (charASCII >= 65 && charASCII <= 90) console.log(`${charASCII} is an uppercase letter`);
 else if (charASCII >= 97 && charASCII <= 122) console.log(`${charASCII} is a lowercase letter`); 
