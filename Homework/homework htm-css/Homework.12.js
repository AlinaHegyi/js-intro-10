...
*/
 const decimal12 = arr => arr.map(n => parseFloat(n.toFixed(2)));

  console.log(decimal12([94.356, 8.9752]))
  console.log(decimal12([76.62, 128.4, 84]))
  console.log(decimal12([20987, 3.53245, 12.345, 32.9]))
  console.log(decimal12([ ]))
  console.log(decimal12([4.35623, 8.9742]))

 
console.log('\n---------------TASK04---------------\n');

/*Write a function named myPow() which takes two numbers, x and n, 
as its arguments and returns x to the power of n without using Math.pow(). 3 to the power of 3 is 3*3*3 = 27. 
